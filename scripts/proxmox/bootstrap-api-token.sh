#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Filename: homelab_2026.1/scripts/proxmox/bootstrap-api-token.sh
# Created: 2026-01-07
...
PVE_USER_NAME="${PVE_USER_NAME:-homelab2026-automation}"
PVE_ROLE_NAME="${PVE_ROLE_NAME:-Homelab2026Role}"
PVE_TOKEN_ID="${PVE_TOKEN_ID:-homelab2026-token}"
